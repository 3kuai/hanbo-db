...
public class BytesKeyZSet extends TreeSet<ZSetEntry> {
  ...
  private redis.util.BytesKeyObjectMap<ZSetEntry> map;

  public BytesKeyZSet() {}

  public BytesKeyZSet(redis.util.BytesKeyZSet destination) {
    super(destination);
  }
  ...
  private redis.util.BytesKeyObjectMap<ZSetEntry> getMap() {
    if (map == null) {
